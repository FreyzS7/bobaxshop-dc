...
CREATE TABLE IF NOT EXISTS `guilds` (
  ...
  `robux_rate_transfer` decimal(10,2),
  ...
  `enable_gamepass` boolean NOT NULL DEFAULT true,
  `enable_transfer` boolean NOT NULL DEFAULT false,
  `roblox_user_id` varchar(32) DEFAULT '456687425',
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `method` enum('gamepass','community','transfer') NOT NULL,
